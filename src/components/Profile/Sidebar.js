    ...
    return (
        <div>
            <ul className="navbar-nav flex-column mt-2">
                ...
                <li className="nav-item"><a href="#" className="nav-link p-3 mb-2 sidebar-link"><i className="fas fa-shopping-cart text-light fa-lg mr-3"></i>Mes offres</a></li>
                ...
                <li className="nav-item"><a href="#" className="nav-link p-3 mb-2 sidebar-link"><i className="fas fa-chart-line text-light fa-lg mr-3"></i>Analytique</a></li>
                <li className="nav-item"><a href="#" className="nav-link p-3 mb-2 sidebar-link"><i className="fas fa-chart-bar text-light fa-lg mr-3"></i>Charts</a></li>
                <li className="nav-item"><a href="#" className="nav-link p-3 mb-2 sidebar-link"><i className="fas fa-wrench text-light fa-lg mr-3"></i>Paramètres</a></li>
                <li className="nav-item"><a href="#" className="nav-link p-3 mb-2 sidebar-link"><i className="fas fa-book text-light fa-lg mr-3"></i>Documentation</a></li>
                ...
                <li className="nav-item"><Link to={{ pathname: '/app/dashboard/payments/deposit-methods'}} className="nav-link p-3 mb-2 sidebar-link"><i className="far fa-credit-card text-light fa-lg mr-3"></i>Dépôt</Link></li>
            </ul>
        </div>
    );
}
